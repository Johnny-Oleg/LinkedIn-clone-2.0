...
const PostModal = ({ user, showModal, postArticle, handleClick }) => {
...
const PostButton = styled.button`
    ...
    border-radius: 20px;
    cursor: pointer;
    background: ${({ disabled }) => disabled ? '#00000014' : '#0a66c2'};
    color: ${({ disabled }) => disabled ? '#0000004D' : '#FFFFFF'};
`;
